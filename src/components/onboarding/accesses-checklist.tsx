  ...
  return (
    <div className="rounded-xl border border-gray-100 bg-white p-6 shadow-sm">
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h2 className="flex items-center gap-2.5 text-lg font-semibold text-gray-900">
            <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#1a1a2e] text-xs font-bold text-white">
        ...
        <div className="flex items-center gap-2">
          <div className="text-right">
            <span className="text-2xl font-bold text-[#1a1a2e]">{completedCount}</span>
      ...
      <div className="mb-6 h-2 overflow-hidden rounded-full bg-gray-100">
        <div
          className="h-full rounded-full bg-gradient-to-r from-[#1a1a2e] to-[#3a3a5e] transition-all duration-500"
      ...
      <div className="space-y-3">
        ...
        <div className="rounded-lg border-2 border-[#1a1a2e]/20 bg-gradient-to-r from-[#1a1a2e]/5 to-transparent p-4">
          <div className="flex items-start gap-3">
            <div className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-md bg-[#1a1a2e] text-white">
            ...
            <div className="flex-1">
              <label className="text-sm font-semibold text-gray-900">
                ...
                <span className="ml-2 rounded-full bg-[#1a1a2e] px-2 py-0.5 text-[10px] font-bold uppercase text-white">Important</span>
              </label>
              ...
              <input
                ...
                className="mt-2 block w-full rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm shadow-sm transition-all placeholder:text-gray-400 focus:border-[#1a1a2e] focus:outline-none focus:ring-2 focus:ring-[#1a1a2e]/10"
        ...
        <div className="rounded-lg border border-gray-100 bg-white p-4">
          ...
          <textarea
            ...
            rows={3}
            className="block w-full rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm shadow-sm transition-all placeholder:text-gray-400 focus:border-[#1a1a2e] focus:outline-none focus:ring-2 focus:ring-[#1a1a2e]/10"
      ...
      <div className="mt-6 flex items-center justify-between">
        <button
          onClick={handleSave}
          disabled={isPending}
          className="rounded-lg bg-[#1a1a2e] px-6 py-2.5 text-sm font-semibold text-white shadow-sm transition-all hover:bg-[#2a2a4e] disabled:opacity-50"
        >
