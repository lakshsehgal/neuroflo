  ...
  ].join(" "),
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-border bg-background text-foreground shadow-xs hover:bg-accent hover:text-accent-foreground hover:border-border",
        secondary:
        ...
        brand:
          "gradient-brand text-brand-foreground shadow-sm hover:shadow-glow hover:brightness-110",
      },
      size: {
