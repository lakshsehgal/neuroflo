            ...
            >
              ...
              <div className="relative">
                <Input
                  ...
                  required
                  className="h-11 rounded-lg border-white/10 bg-white/5 text-white placeholder:text-white/25 focus:border-amber-500/40 focus:ring-amber-500/20 transition-colors pr-10"
                />
                <button
                  type="button"
